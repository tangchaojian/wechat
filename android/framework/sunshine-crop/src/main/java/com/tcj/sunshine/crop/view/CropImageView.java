...
import com.tcj.sunshine.crop.model.CropParameters;
import com.tcj.sunshine.crop.model.ImageState;
import com.tcj.sunshine.tools.LogUtils;
import com.yalantis.ucrop.task.BitmapCropTask;
import com.tcj.sunshine.crop.util.CubicEasing;
...
public class CropImageView extends TransformImageView {
    ...
    public void postScale(float deltaScale, float px, float py) {
        LogUtils.i("sunshine-crop", "deltaScale->" + deltaScale);
    ...
    public void postScale(float deltaScale) {
        postScale(deltaScale, mCropRect.centerX(), mCropRect.centerY());
    }
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        float targetAspectRatioX = Math.abs(a.getFloat(R.styleable.crop_CropView_crop_aspect_ratio_x, DEFAULT_ASPECT_RATIO));
        float targetAspectRatioY = Math.abs(a.getFloat(R.styleable.crop_CropView_crop_aspect_ratio_y, DEFAULT_ASPECT_RATIO));
