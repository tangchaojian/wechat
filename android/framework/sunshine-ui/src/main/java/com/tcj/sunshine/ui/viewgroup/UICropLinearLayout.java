...
public class UICropLinearLayout extends LinearLayout {
    ...
    public UICropLinearLayout(Context context) {
        super(context);
        this.initUI(context, null);
    }

    public UICropLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initUI(context, attrs);
    }

    public UICropLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initUI(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public UICropLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
