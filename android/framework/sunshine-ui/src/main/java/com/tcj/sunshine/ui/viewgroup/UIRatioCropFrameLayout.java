 ...
 * 比例布局
 */
public class UIRatioCropFrameLayout extends UICropFrameLayout {

    private int ratio_width;
    private int ratio_height;

    public UIRatioCropFrameLayout(Context context) {
        super(context);
    }

    public UIRatioCropFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public UIRatioCropFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @SuppressLint("NewApi")
    public UIRatioCropFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
