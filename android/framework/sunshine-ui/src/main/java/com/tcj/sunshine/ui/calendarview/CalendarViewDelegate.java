...
final class CalendarViewDelegate {
     ...
     * 日期拦截事件
     */
    UICalendarView.OnCalendarInterceptListener mCalendarInterceptListener;

    /**
     * 日期选中监听
     */
    UICalendarView.OnCalendarSelectListener mCalendarSelectListener;

    /**
     * 范围选择
     */
    UICalendarView.OnCalendarRangeSelectListener mCalendarRangeSelectListener;


    /**
     * 多选选择事件
     */
    UICalendarView.OnCalendarMultiSelectListener mCalendarMultiSelectListener;

    /**
     * 外部日期长按事件
     */
    UICalendarView.OnCalendarLongClickListener mCalendarLongClickListener;

    /**
     * 内部日期切换监听，用于内部更新计算
     */
    UICalendarView.OnInnerDateSelectedListener mInnerListener;

    /**
     * 快速年份切换
     */
    UICalendarView.OnYearChangeListener mYearChangeListener;


    /**
     * 月份切换事件
     */
    UICalendarView.OnMonthChangeListener mMonthChangeListener;

    /**
     * 周视图改变事件
     */
    UICalendarView.OnWeekChangeListener mWeekChangeListener;

    /**
     * 视图改变事件
     */
    UICalendarView.OnViewChangeListener mViewChangeListener;


    /**
     * 年视图改变事件
     */
    UICalendarView.OnYearViewChangeListener mYearViewChangeListener;
