 ...
 */
package com.tcj.sunshine.ui.calendarview;
...
public class UICalendarLayout extends LinearLayout {
     ...
     * 日历
     */
    UICalendarView mUICalendarView;
...
//    private static final int GESTURE_MODE_ONLY_CALENDAR = 1;
    ...
    public UICalendarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOrientation(LinearLayout.VERTICAL);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.UICalendarLayout);
        mContentViewId = array.getResourceId(R.styleable.UICalendarLayout_calendar_content_view_id, 0);
        mDefaultStatus = array.getInt(R.styleable.UICalendarLayout_default_status, STATUS_EXPAND);
        mCalendarShowMode = array.getInt(R.styleable.UICalendarLayout_calendar_show_mode, CALENDAR_SHOW_MODE_BOTH_MONTH_WEEK_VIEW);
        mGestureMode = array.getInt(R.styleable.UICalendarLayout_gesture_mode, GESTURE_MODE_DEFAULT);
        array.recycle();
    ...
    public void hideCalendarView() {
        if (mUICalendarView == null) {
            return;
        }
        mUICalendarView.setVisibility(GONE);
        if (!isExpand()) {
            expand(0);
        }
        requestLayout();
    ...
    public void showCalendarView() {
        ...
        mUICalendarView.setVisibility(VISIBLE);
        requestLayout();
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (mContentView == null || mUICalendarView == null || mUICalendarView.getVisibility() == GONE) {
            return false;
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (mYearView == null ||
                mUICalendarView == null || mUICalendarView.getVisibility() == GONE ||
                mContentView == null ||
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mContentView == null || mUICalendarView == null) {
        ...
        int h;
        if (mCalendarShowMode == CALENDAR_SHOW_MODE_ONLY_MONTH_VIEW ||
                mUICalendarView.getVisibility() == GONE) {
            h = height - (mUICalendarView.getVisibility() == GONE ? 0 : mUICalendarView.getHeight());
    ...
    protected void onFinishInflate() {
        ...
        if (getChildCount() > 0) {
            mUICalendarView = (UICalendarView) getChildAt(0);
        }
