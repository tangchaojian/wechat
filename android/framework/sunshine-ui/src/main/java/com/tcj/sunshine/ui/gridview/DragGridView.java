...
public class DragGridView extends GridView {
    ...
    private boolean isMove = false;//点击之后是否移动过
    ...
    public DragGridView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStatusHeight = ScreenUtils.getStatusBarHeight();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()){
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                boolean result = isDrag;
                intercept = false;
                onStopDrag();
                isDrag = true;
                if(touchEventListener != null && isMove) {
                    touchEventListener.onTouchUp();
                }
