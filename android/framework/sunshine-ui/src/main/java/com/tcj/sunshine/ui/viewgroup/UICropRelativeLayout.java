...
public class UICropRelativeLayout extends RelativeLayout {
    ...
    public UICropRelativeLayout(Context context) {
        super(context);
        this.initUI(context, null);
    }

    public UICropRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initUI(context, attrs);
    }

    public UICropRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initUI(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public UICropRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
