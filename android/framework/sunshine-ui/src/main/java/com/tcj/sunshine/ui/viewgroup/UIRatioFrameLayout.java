 ...
 * 比例布局
 */
public class UIRatioFrameLayout extends FrameLayout {

    private int ratio_width;
    private int ratio_height;

    public UIRatioFrameLayout(Context context) {
        super(context);
    }

    public UIRatioFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public UIRatioFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @SuppressLint("NewApi")
    public UIRatioFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
