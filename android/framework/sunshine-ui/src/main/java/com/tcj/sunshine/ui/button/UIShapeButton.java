...
/**
 * 自定义Button，可以显示各种背景，圆角，形状
 */

public class UIShapeButton extends AppCompatButton {
    ...
    public UIShapeButton(Context context) {
        super(context);
        this.initUI(context, null);
    }

    public UIShapeButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initUI(context, attrs);
    }

    public UIShapeButton(Context context, AttributeSet attrs, int defStyleAttr) {
