...
/**
 * 自定义LinearLayout，可以显示各种背景，圆角，形状
 */
public class UIShapeLinearLayout extends LinearLayout {
    ...
    public UIShapeLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initUI(context, attrs);
    }

    public UIShapeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initUI(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public UIShapeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
