...
public class UICalendarView extends FrameLayout {
     ...
     * 日历外部收缩布局
     */
    UICalendarLayout mParentLayout;


    public UICalendarView(@NonNull Context context) {
        this(context, null);
    }

    public UICalendarView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        if (getParent() != null && getParent() instanceof UICalendarLayout) {
            mParentLayout = (UICalendarLayout) getParent();
