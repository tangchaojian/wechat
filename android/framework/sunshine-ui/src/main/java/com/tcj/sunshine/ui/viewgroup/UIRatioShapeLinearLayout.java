 ...
 * 比例布局
 */
public class UIRatioShapeLinearLayout extends UIShapeLinearLayout {

    private int ratio_width;
    private int ratio_height;

    public UIRatioShapeLinearLayout(Context context) {
        super(context);
    }

    public UIRatioShapeLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public UIRatioShapeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @SuppressLint("NewApi")
    public UIRatioShapeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
