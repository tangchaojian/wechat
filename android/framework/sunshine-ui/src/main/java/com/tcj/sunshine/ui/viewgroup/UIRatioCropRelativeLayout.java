 ...
 * 比例布局
 */
public class UIRatioCropRelativeLayout extends UICropRelativeLayout {

    private int ratio_width;
    private int ratio_height;

    public UIRatioCropRelativeLayout(Context context) {
        super(context);
    }

    public UIRatioCropRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public UIRatioCropRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @SuppressLint("NewApi")
    public UIRatioCropRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
