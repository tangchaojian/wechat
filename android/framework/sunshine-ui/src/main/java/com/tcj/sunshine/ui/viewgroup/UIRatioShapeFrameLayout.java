 ...
 * 比例布局
 */
public class UIRatioShapeFrameLayout extends UIShapeFrameLayout {

    private int ratio_width;
    private int ratio_height;

    public UIRatioShapeFrameLayout(Context context) {
        super(context);
    }

    public UIRatioShapeFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public UIRatioShapeFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @SuppressLint("NewApi")
    public UIRatioShapeFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
