package com.tcj.sunshine.ui.button;
...
/**
 * Created by lx on 2018/5/18.
 */

public class UIShapeRadioButton extends AppCompatRadioButton {
    ...
    public UIShapeRadioButton(Context context) {
        super(context);
        this.initUI(context, null);
    }

    public UIShapeRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initUI(context, attrs);
    }

    public UIShapeRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initUI(Context context, AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            int colorCheckedId = typedArray.getResourceId(R.styleable.ShapeViewStyle_shape_checked_color, 0);
            if(colorCheckedId > 0){
                this.colorChecked = ContextCompat.getColor(context, colorCheckedId);
            }else{
                this.colorChecked = typedArray.getColor(R.styleable.ShapeViewStyle_shape_checked_color, 0x0);
            }
            ...
            if(this.isShowborder) {
                ...
                int colorLineCheckedId = typedArray.getResourceId(R.styleable.ShapeViewStyle_shape_checked_line_color, 0);
                if(colorLineCheckedId > 0){
                    this.colorLineChecked = ContextCompat.getColor(context, colorLineCheckedId);
                }else{
                    this.colorLineChecked = typedArray.getColor(R.styleable.ShapeViewStyle_shape_checked_line_color, 0);
                }
            ...
            int colorTextCheckedId = typedArray.getResourceId(R.styleable.ShapeViewStyle_shape_checked_text_color, 0);
            if(colorTextCheckedId > 0){
                this.colorTextChecked = ContextCompat.getColor(context, colorTextCheckedId);
            }else{
                this.colorTextChecked = typedArray.getColor(R.styleable.ShapeViewStyle_shape_checked_text_color, 0);
            }
            ...
            if(isShowborder) {
                ...
                shapeChecked.setStroke(lineWidth, colorLineChecked);
            }
            ...
            if(colorChecked == 0x0) {
                ...
                drawable.addState(new int[]{android.R.attr.state_checked}, shapeChecked);
                drawable.addState(new int[]{-android.R.attr.state_enabled}, shapeUnable);
                drawable.addState(new int[]{}, shapeNormal);
            }
            ...
            if(colorTextNormal != 0x0 || colorTextPressed != 0x0 || colorTextUnable != 0x0 || colorTextChecked != 0x0) {

                if(colorTextPressed == 0) colorTextPressed = colorTextNormal;
                if(colorTextPressed == 0) colorTextUnable = colorTextNormal;

                if(colorTextChecked == 0x0) {
                    ...
                    int[] colors = new int[]{colorTextChecked, colorTextUnable, colorTextNormal};
                    int[][] states = new int[3][];
