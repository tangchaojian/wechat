...
package com.tcj.sunshine.boxing.model.config;
...
public class BoxingConfig implements Parcelable {
    ...
    public ArrayList<BaseMedia> list;
    public ArrayList<BaseMedia> selectedList;
    public Map<String, BaseMedia> selectedMap;

    public enum Mode {
        SINGLE_IMG, MULTI_IMG, MULTI_IMG_AND_VIDEO, VIDEO, AUDIO
    }
