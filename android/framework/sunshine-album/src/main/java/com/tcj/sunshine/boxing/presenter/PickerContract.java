...
public interface PickerContract {
    ...
    interface View {
         ...
         * @param allCount
         */
        void showVideo(@Nullable List<BaseMedia> medias, int allCount);

        /**
         * show a list  the {@link BaseMedia} in the view
         */
        void showAudio(@Nullable List<BaseMedia> medias, int allCount);
    ...
    interface Presenter {
         ...
         * @param albumId album albumId
         */
        void loadVideos(int page, String albumId);
         ...
         * @param albumId album albumId
         */
        void loadAudios(int page, String albumId);
