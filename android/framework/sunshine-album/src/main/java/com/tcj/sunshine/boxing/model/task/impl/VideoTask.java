 ...
 */
@WorkerThread
public class VideoTask implements IVideoTask<VideoMedia> {
    ...
    private final static String[] MEDIA_COL = new String[]{
            ...
            MediaStore.Video.Media.DATE_MODIFIED//最后一次更新时间
    };


    @Override
    public void load(final ContentResolver cr, final int page, String id, final IVideoTaskCallback<VideoMedia> callback) {
        loadVideos(cr, page, callback);
    }

    private void loadVideos(ContentResolver cr, int page, @NonNull final IVideoTaskCallback<VideoMedia> callback) {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    ...
                    String mDateModified = cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.DATE_MODIFIED));
                    VideoMedia video = new VideoMedia.Builder(id, data)
                            .setTitle(title)
    ...
    private void postMedias(@NonNull final IVideoTaskCallback<VideoMedia> callback,
