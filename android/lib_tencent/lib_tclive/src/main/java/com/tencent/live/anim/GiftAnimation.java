...
public class GiftAnimation {
    ...
    private Queue<TIMMessage> cache = new LinkedList<>();
    ...
    // 收到礼物，等待显示动画
    public void showGiftAnimation(final TIMMessage message) {
        cache.add(message);
        checkAndStart();
    }
    ...
    private void updateView(final TIMMessage message, ViewGroup root) {
