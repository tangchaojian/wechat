...
class _UITabBarViewDemo extends State<UITabBarViewDemo> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    bannerWidth = ScreenUtils.getScreen(context)[0] - 2 * 10;
